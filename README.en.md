...
Windows distribution files are published through GitHub Releases. Pushing a version tag such as `v0.1.5` runs GitHub Actions on Windows, builds the `.exe` and `.msi` installers, and uploads them to that release.
